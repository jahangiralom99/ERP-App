...
const NewExpenseItem = ({ setOpen3 }) => {
  ...
  return (
    <div className="text-black text-sm fixed bottom-10 left-0 right-0 z-10 bg-slate-200 ">
      <div>
        <div className="flex justify-end gap-24 font-bold p-3">
        ...
        <form className="px-5">
          ...
          <fieldset className="relative border-[1px] border-gray-600 rounded-xl">
            ...
            <div className="flex  gap-4 items-center w-full pl-4 pb-2">
              ...
              />
              <DatePicker
                className="bg-transparent text-black font-medium outline-none "
                selected={startDate}
                onChange={(date) => {
                  setStartDate(date);
          ...
          {open1 && (
            <div className=" fixed bottom-24 px-3 left-1/2 -translate-x-1/2  bg-white rounded-box z-[1] w-[300px] p-2 shadow">
              <div>

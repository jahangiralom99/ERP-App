...
import { FaBuildingColumns, FaCirclePlus } from "react-icons/fa6";
...
const CreateOrder = () => {
 ...
 const handleCalendarClick = () => {
    ...
    return (
        <div className="bg-gray-100 pb-12  h-screen text-black">
            {/* heading */}
            ...
            <div className="p-5 flex flex-col gap-2">
                ...
                <fieldset className="relative border-[1px] border-gray-600 rounded-xl ">
                    ...
                    <LuBuilding2 className="text-zinc-500" />
                ...
                <fieldset className="relative border-[1px] border-gray-600 rounded-xl ">
                    ...
                    <div className=" flex justify-between gap-2 items-center w-full pl-4 pb-2">
                    <FaBuildingColumns  className="text-zinc-500" />
            ...
            <div className="px-5 flex flex-col">
                <div className="flex flex-col gap-3">
                    <button className="w-full bg-blue-100 p-2 rounded-xl flex justify-center items-center gap-2 "> <FaCirclePlus className="text-blue-600 bg-white rounded-full text-xl" /> Add item Details</button>
                ...
                <div className="flex gap-3 px-5 fixed bottom-2 left-0 right-0 justify-center">
